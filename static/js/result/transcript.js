...
$(function () {
    ...
    const HELP_CONTENTS = {
        ...
        length_adequacy: {
            title: "답변 길이 적절성 도움말",
            meaning: "답변 시간을 기준 범위와 비교하여 답변 길이의 적정성을 판단하는 지표입니다.",
            criteria: [
                "70초 미만이면 다소 짧은 답변 상태입니다.",
                "110초를 초과하면 다소 긴 답변 상태입니다.",
                "70~110초 구간이면 적정 길이 상태입니다.",
            ],
            evaluation: "이 지표는 답변 시간이 목표 구간에 들어오는지를 판단하는 핵심 길이 평가 기준입니다.",
        },
        avg_sentence_length: {
            title: "문장 평균 길이 도움말",
    ...
    const HELP_AGGREGATIONS = {
        ...
        length_adequacy: "답변 시간 기준으로 적정 구간(70~110초) 밴드 점수 방식으로 계산합니다.",
